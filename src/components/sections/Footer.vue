      ...
      <div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div class="flex items-center gap-2 mb-4">
              <div class="relative w-8 h-8">
                <div class="absolute inset-0 bg-gradient-to-r from-purple-500 to-blue-500 rounded-full"></div>
                <div class="absolute inset-1 bg-gray-900 rounded-full flex items-center justify-center">
                  <span class="text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-blue-500 text-sm font-bold">W3</span>
                </div>
              </div>
          ...
          <div>
            ...
            <ul class="space-y-2">
              <li><a href="#about" class="text-gray-400 hover:text-white transition-colors">{{ t('nav.about') }}</a></li>
              <li><a href="#skills" class="text-gray-400 hover:text-white transition-colors">{{ t('nav.skills') }}</a></li>
              <li><a href="#projects" class="text-gray-400 hover:text-white transition-colors">{{ t('nav.projects') }}</a></li>
              <li><a href="#background" class="text-gray-400 hover:text-white transition-colors">{{ t('nav.background') }}</a></li>
              <li><a href="#contact" class="text-gray-400 hover:text-white transition-colors">{{ t('nav.contact') }}</a></li>
            </ul>
          </div>
          
          <div>
            <h3 class="text-lg font-semibold mb-4">{{ t('footer.resources') }}</h3>
            <ul class="space-y-2">
              <li><a href="#" class="text-gray-400 hover:text-white transition-colors">{{ t('footer.blog') }}</a></li>
              <li><a href="#" class="text-gray-400 hover:text-white transition-colors">{{ t('footer.tutorials') }}</a></li>
              <li><a href="#" class="text-gray-400 hover:text-white transition-colors">{{ t('footer.docs') }}</a></li>
              <li><a href="#" class="text-gray-400 hover:text-white transition-colors">{{ t('footer.newsletter') }}</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul class="space-y-2">
              ...
              <li><a href="#" class="text-gray-400 hover:text-white transition-colors">{{ t('footer.cookies') }}</a></li>
            </ul>
          </div>
        </div>
        ...
        <div class="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p class="text-gray-500 text-sm">
            &copy; {{ new Date().getFullYear() }} {{ t('nav.name') }}. {{ t('footer.copyright') }}
          </p>
          <div class="mt-4 md:mt-0 flex items-center">
            <button @click="toggleLanguage" class="text-gray-400 hover:text-white transition-colors text-sm flex items-center">
              <span class="mr-2">{{ currentLang === 'en' ? '🇺🇸' : '🇪🇸' }}</span>
