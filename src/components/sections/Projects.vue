    ...
    <div class="container mx-auto px-4">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <div
          ...
          :key="project.id"
          class="bg-white dark:bg-gray-900 rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow border border-gray-100 dark:border-gray-800 group"
        >
            ...
            >
              <div class="flex gap-2">
                <a
                  ...
                  class="px-3 py-1 bg-white text-gray-900 rounded-full text-sm font-medium hover:bg-gray-100 transition-colors"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  class="px-3 py-1 bg-gray-900 text-white rounded-full text-sm font-medium hover:bg-gray-800 transition-colors"
                >
          ...
          <div class="p-6">
            ...
            <div class="flex flex-wrap gap-2 mb-4">
              <span
                ...
                :key="tag"
                class="px-2 py-1 bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 rounded-md text-xs"
              >
                {{ tag }}
              </span>
            </div>
