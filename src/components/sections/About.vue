      ...
      <div class="max-w-3xl mx-auto">
        ...
        <div class="bg-white dark:bg-gray-900 rounded-xl shadow-xl p-6 md:p-8">
          <div class="flex flex-col md:flex-row gap-8 items-center">
            <div
              class="w-48 h-48 rounded-full overflow-hidden flex-shrink-0 border-4 border-primary shadow-lg"
            >
              <img
            ...
            <div class="flex flex-col mx-auto">
              <div
                class="space-y-2 justify-items-center md:justify-items-start"
              >
                <ContactItem
          ...
          <div class="mt-8">
            <h4 class="text-xl font-semibold mb-4">
              {{ t("about.what_i_do_title") }}
            </h4>
            <p class="text-gray-700 dark:text-gray-300 mb-4">
              {{ t("about.what_i_do_description") }}
            </p>

            <h4 class="text-xl font-semibold mb-4 mt-6">
